...
<th colspan="3" style="color:#fff;font-size:18px;">ITEMS TABLE </th>
 <tr>
  ...
  <select name="category" id="categories" onchange="updateSubCat()" style="background-color:lightblue">
	<option value=""></option>
	<option value="lifeforms">Lifeforms</option>
	<option value="vendortrash">Vendortrash</option>
	<option value="tradegoods">Tradegoods</option>
...
<tr>
  <td>Description:&nbsp;&nbsp;</td>
  <td><textarea name="description" rows="2"  size="20" maxlength="300" value="<?php if(isset($_POST['description'])) echo $_POST['description'];?>">
  </textarea></td>
  <td>
  <div align="left"><button class="btn023" name="submit">Preview<span><img src="images/p1.png" alt="" /></span></button></div>
