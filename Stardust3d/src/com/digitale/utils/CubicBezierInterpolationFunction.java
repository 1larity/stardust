...
* @author acoppes
*/
public class CubicBezierInterpolationFunction implements InterpolationFunction {

private final float p0, p1, p2, p3;

public CubicBezierInterpolationFunction(float p0, float p1, float p2, float p3) {
this.p0 = p0;
this.p1 = p1;
this.p2 = p2;
this.p3 = p3;
